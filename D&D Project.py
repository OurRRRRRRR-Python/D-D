...
"""
#Still figuring out if I'll need this
def BackgroundStuff():
    Languages = []
    if CharRace == "Dragonborn":
        Languages.append("Common")
...
def Equipment():
    ...
    "Morning Star", "Pike", "Rapier", "Scimitar", "Shortsword", "Trident", "War Pick", "War Hammer", "Whip")
    ...
    if CharClass == "Cleric":
        ...
        if Case3 < 3:
            CharEquips.append("Light Crossbow with 20 bolts")
        if Case3 == 3:
            CharEquips.append(random.choice(WeaponsSimpleMelee))
        if Case3 == 4:
            CharEquips.append(random.choice(WeaponsSimpleRanged))
    ...
    if CharClass == "Fighter":
        ...
        if Case1 == 2 :
            CharEquips.append("Leather armor")
            CharEquips.append("Longbow and 20 arrows")
        if Case2 < 3 :
            CharEquips.append(random.choice(WeaponsMartialMelee))
            CharEquips.append("Shield")
        if Case2 == 3 :
    ...
    if CharClass == "Ranger":
        ...
        if Case3 == 2 :
            CharEquips.append("explorer's pack")
        CharEquips.append("Longbow and quiver of 20 arrows")
    if CharClass == "Rogue":
        CharEquips = []
        Case1 = randint(1,2)
        Case2 = randint(1,2)
        ...
        if Case2 == 1 :
            CharEquips.append("Shortsword")
        if Case2 == 2 :
            CharEquips.append("Shortbow and quiver of 20 arrows")
        if Case3 == 1:
